...
public class utils {
    ...
    public static Response HitAPIWithTokenDynamic(String UrlNameFromConfig, String method, String step, Map<String, String> headers) throws Exception {
        Response response = new Response();
        try {
            Request request = new Request();
            String url = ProjectConfigData.getProperty(UrlNameFromConfig);
            String new_url = url;
            GemTestReporter.addTestStep("Url for " + method.toUpperCase() + " Request", new_url, STATUS.INFO);
...
//            Object value=null;
//            List<String> list= Collections.singletonList(response.getResponseBody());
...
//            System.out.println(json);
    ...
    public static Response HitAPIPostToken7(String UrlNameFromConfig, String method, String step, Map<String, String> headers) throws Exception {
        Response response = new Response();
        try {
            Request request = new Request();
            String url = ProjectConfigData.getProperty(UrlNameFromConfig);
    ...
    public static Response HitAPIPostToken8(String UrlNameFromConfig, String method, String step, Map<String, String> headers) throws Exception {
        Response response = new Response();
        try {
            Request request = new Request();
            String url = ProjectConfigData.getProperty(UrlNameFromConfig);
    ...
    public static Response HitAPIPostToken9(String UrlNameFromConfig, String method, String step, Map<String, String> headers) throws Exception {
        Response response = new Response();
        try {
            Request request = new Request();
            String url = ProjectConfigData.getProperty(UrlNameFromConfig);
    ...
    public static Response CheckAPiWithAuth5(String UrlNameFromConfig, String method, String bt, String sampleName) throws Exception {
        Response response = new Response();
        try {
            GemTestReporter.addTestStep("Test Case", "Test using " + method.toUpperCase() + "API  ", STATUS.INFO);
            String url = ProjectConfigData.getProperty(UrlNameFromConfig);
            ...
            JsonObject pay = (JsonObject) parser.parse(payloads);
            String payload = String.valueOf(ApiHealthCheckUtils.result(pay));
            JsonObject pay2 = (JsonObject) parser.parse(payload);
            username = String.valueOf(pay2.get("username"));
